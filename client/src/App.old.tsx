...
import { Activity, CheckCircle2, XCircle, Moon, Sun, Sparkles, Clock, DollarSign, Shield, AlertCircle, TrendingUp, Timer, Copy } from 'lucide-react';
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      <div className="p-4 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-lg border border-blue-200 dark:border-blue-800">
                        ...
                        <div className="text-lg font-bold text-blue-900 dark:text-blue-100">
                          ${response.costAnalysis.totalRetryCost.toLocaleString()}
                        </div>
                        <div className="text-xs text-blue-600 dark:text-blue-400 mt-1">
                          ${response.costAnalysis.retryFeePerAttempt} × {response.retryRecommendation?.maxRetries || 0}
                        </div>
                      </div>
                      <div className="p-4 bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-lg border border-green-200 dark:border-green-800">
                        ...
                        <div className="text-lg font-bold text-green-900 dark:text-green-100">
                          ${response.costAnalysis.expectedRevenue.toLocaleString()}
                        </div>
                        <div className="text-xs text-green-600 dark:text-green-400 mt-1">
                          {(response.estimatedSuccessProbability * 100).toFixed(1)}% success
                        </div>
                      </div>
                      <div className="p-4 bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 rounded-lg border border-purple-200 dark:border-purple-800">
                        ...
                        <div className="text-lg font-bold text-purple-900 dark:text-purple-100">
                          {response.costAnalysis.roi === Infinity ? '∞' : `+${response.costAnalysis.roi.toLocaleString()}%`}
                        </div>
                      ...
                      <div className="p-4 bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 rounded-lg border border-orange-200 dark:border-orange-800">
                        ...
                        <div className="text-lg font-bold text-orange-900 dark:text-orange-100">
                          ${response.costAnalysis.potentialRevenue.toLocaleString()}
                        </div>
